...
export default function Sea() {
  return (
    <>
        <ServiceHero title='Морские перевозки' routes={[{title:'Главная', href: '/'}, {title:'Услуги', href: '/services'}, {title:'Морские перевозки', href: 'sea'}]} img_url='/services/unsplash_1cqIcrWFQBI.png' />
        <PageWithSidebar>
